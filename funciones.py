#funciones en py
#retorna el valor absoluto del parametro que le pase
'''
n=-12
print('el resultado de abs es:',abs(n))
'''
'''
...
print('el resultado de divmod:', cociente,'y el resto:',resto)
'''
'''
#Convierte una cadena de txt a dicmal 
f='23.54'
print('el resultado de la funcion float es ',float(f))
'''
'''
#obyoene la version a hexadecimal
g=124
print('el resultado de la funcion hex es:',hex(g))
'''
'''
#le pide al usuario que ingrese una string
...
i=123
pirnt('El resultado de la funcion int es:', int(i))
'''
'''
#Retorna la longitud del objeto to0mado por parametro
j=12,23,45
